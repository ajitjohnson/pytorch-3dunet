...
def load_config():
    ...
    parser.add_argument(
        "--loaders.test.file_paths", type=str, nargs="+", required=False
    )
    parser.add_argument(
        "--loaders.test.slice_builder.patch_shape", type=int, nargs="+", required=False
    )
    parser.add_argument(
        "--loaders.test.slice_builder.stride_shape", type=int, nargs="+", required=False
    )
